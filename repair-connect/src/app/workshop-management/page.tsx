  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Building2 className="w-4 h-4 text-[var(--ns-green)]" />
                <span className="text-sm">Business Information & Images</span>
              </div>
              <div className="flex items-center gap-2">
                <Briefcase className="w-4 h-4 text-[var(--ns-green)]" />
                <span className="text-sm">Portfolio Management</span>
              </div>
              <div className="flex items-center gap-2">
                <Award className="w-4 h-4 text-[var(--ns-green)]" />
                <span className="text-sm">Certification Tracking</span>
              </div>
              <div className="flex items-center gap-2">
                <Camera className="w-4 h-4 text-[var(--ns-green)]" />
        ...
        {/* Demo Card */}
        <Card className="border-2 border-[var(--ns-cyan)]/20 hover:border-[var(--ns-cyan)]/40 transition-colors">
          <CardHeader className="text-center">
            <div className="mx-auto w-16 h-16 bg-[var(--ns-cyan-light)] rounded-full flex items-center justify-center mb-4">
              <Eye className="w-8 h-8 text-[var(--ns-cyan)]" />
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Upload className="w-4 h-4 text-[var(--ns-cyan)]" />
                <span className="text-sm">Image Upload System</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-[var(--ns-cyan)]" />
                <span className="text-sm">Interactive Components</span>
              </div>
              <div className="flex items-center gap-2">
                <Eye className="w-4 h-4 text-[var(--ns-cyan)]" />
                <span className="text-sm">Live Feature Preview</span>
              </div>
              <div className="flex items-center gap-2">
                <Building2 className="w-4 h-4 text-[var(--ns-cyan)]" />
                <span className="text-sm">Mock Data Examples</span>
              </div>
            </div>
            
            <Button asChild variant="outline" className="w-full border-[var(--ns-cyan)]/20 text-[var(--ns-cyan)] hover:bg-[var(--ns-cyan-light)]/50">
      ...
      <div className="flex items-center justify-center gap-4 flex-wrap">
        ...
        <Badge variant="outline" className="bg-[var(--primary-100)] text-[var(--primary-700)] border-[var(--primary-600)]/20">
